...
<section style="min-height:80vh; padding:60px 0 60px;">
    ...
    <div class="grid-wawasan-container" style="max-width:1200px; margin:0 auto; padding: 0 80px;">
        ...
        @php
        $analyses = [
            ['param_name'=>'pH', 'param_desc'=>'Indikator tingkat asam atau basa dalam air. pH yang tidak stabil dapat memicu korosi pada instalasi pipa logam jika terlalu asam, atau meninggalkan rasa pahit seperti sabun serta kerak putih jika air terlalu basa.', 'header_image'=>'assets/ph.jpeg', 'batas_aman'=>'6.5 - 8.5', 'satuan'=>'pH'],
            ['param_name'=>'Hardness', 'param_desc'=>'Mengukur kadar mineral kalsium dan magnesium dalam air. Air dengan kesadahan tinggi dapat menyebabkan penumpukan kerak pada pipa dan peralatan dapur, serta membuat sabun sulit berbusa.', 'header_image'=>'assets/hardness.jpeg', 'batas_aman'=>'< 500', 'satuan'=>'mg/L'],
            ['param_name'=>'Solids', 'param_desc'=>'Indikator jumlah total mineral, garam, dan logam yang terlarut. TDS yang terlalu tinggi dapat memengaruhi rasa air menjadi payau atau pahit.', 'header_image'=>'assets/TDS.jpeg', 'batas_aman'=>'< 1000', 'satuan'=>'mg/L'],
